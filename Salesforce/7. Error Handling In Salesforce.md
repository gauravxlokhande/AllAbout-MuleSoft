...
##  Note: On Error Continue Works like if this perticular selected type error is happened then skip giving error and continue forward all stages in above block.

## Note: On Error Propagate works like if any error or perticular type error occurs then it shows error 500 and execute error block and failed.
